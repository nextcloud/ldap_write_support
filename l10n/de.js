OC.L10N.register(
    ...
    "To create users, the acting (sub)admin has to be provided by LDAP." : "Um Benutzer anzulegen, muss die amtierende (Sub-)Administration über LDAP bereitgestellt werden.",
    "A random user ID has to be generated, i.e. not being provided by the (sub)admin." : "Es muss eine zufällige Konto-ID generiert werden, d. h. sie darf nicht von der (Sub-)Administration bereitgestellt werden.",
